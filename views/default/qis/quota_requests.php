...
$content = '';
if ($quotas) {
	$content = '<div><table id="qis_ris_big"><tr><th>Request ID</th><th>Quantity</th><th>Citizenship</th><th>Gender</th><th>Occupation</th><th>Status</th><th>Action</th></tr>';
	foreach ($quotas as $quota) {
		$content .= elgg_view('qis/quota_request',array('group_guid'=> $group_guid,'quota' => $quota));
	}
        $content .= '</table></div>';
}
$content .= '<div id="elgg-add-buttons-quota">';
